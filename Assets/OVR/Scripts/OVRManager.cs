		...
		get {
			if (!_profileIsCached)
			{
				...
				_profile = new Profile
				{
					ipd = ipd,
					eyeHeight = eyeHeight,
// cdivossen: Set eyeDepth to 0 to to reduce camera movement, to prevent rendered object to move in front of the 
// fixed/prerendered panoramic background
//					eyeDepth = neckToEyeOffset[0],
//					neckHeight = neckHeight,
					eyeDepth = 0.0f,
					neckHeight = eyeHeight,
				};
#else
				float ipd = 0.0f;
